...
public:
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		CControlUI* pRoot = builder.Create(_T("skin.xml"),&cb, &m_pm);
...
//		case WM_PAINT:       lRes = OnNcPaint(uMsg, wParam, lParam, bHandled); break;
//		case WM_HITTEST:     lRes = OnNcHitTest(uMsg, wParam, lParam, bHandled); break;
...
//	if( FAILED(Hr) ) return 0;
	...
	pFrame->Create(NULL, _T("360安全卫士"), 0, 0L);
	pFrame->CenterWindow();
